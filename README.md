It's a basic MERN stack project which name is WeTalk. It is basically simple chatting application where some basic features of a chatting app were developed. Features are written in below:
